    ...
    def test_no_migrations_or_sql_folders(self):
        ...
        self.assertTupleEqual(
            ...
            (
                ...
                "- Raw SQL operation",
                "Created new SQL view file - 'view-food_sweets-0002.sql'.",
                "Modified migration '0002_create_view' to read from 'view-food_sweets-0002.sql'.",
                "Done - You can now edit 'view-food_sweets-0002.sql'.",
            ),
        )
        ...
        self.assertTrue(os.path.exists("tests/food/sql/view-food_sweets-0002.sql"))
